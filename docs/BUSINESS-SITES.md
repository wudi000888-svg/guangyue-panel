...
| --- | --- | --- |
| `guangyue-panel-lite-0.19.0-linux-amd64.tar.gz` | 单 VPS 低资源部署 | Lite / SQLite / 单机管理 |
| `guangyue-panel-pro-0.19.0-linux-amd64.tar.gz` | 主控或业务站 | 默认主控；传 `--role business` 安装业务站 |
